...
/*The Bubble class encapsulates the properties and behaviors of a bubble in the Bubble Shooter game. 
It includes fields for the bubble's color, visibility, location, and marking status.
The class provides methods to manipulate and query these properties, such as setting and getting the bubble's location,
marking and unmarking the bubble, and painting the bubble on the screen. 
The getRandomColor method is a utility function to generate random colors for the bubbles. */